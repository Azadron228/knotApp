...
class Router
{
  ...
  public function handle(ServerRequest $route, $requestUri)
  {
  ...
  public function matchRoute($requestMethod, $requestUri): void
  {
  ...
  public function callClosure($route, $params)
  {
