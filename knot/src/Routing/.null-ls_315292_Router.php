...
class Router
{
  ...
  public function addRoute(string $uri, string $requestMethod = "GET", array|callable $target, string $name = null, array $middleware = [])
  {
    $route = new Route($uri, $requestMethod, $target);
    $this->routes[] = $route;
    return $route;
  }
